const insertDummyData = (db, transactions_db) => {
    ...
    for(var i = 0; i<=9; i+=1)
    {
        ...
        db.query(`insert into EventData (eventName,eventOrWorkshop,departmentAbbr,groupOrIndividual,maxCount,description,eventManagerEmail,date,eventTime,venue,fees,totalNumberOfSeats,noOfRegistrations,timeStamp,refundable) values ('EVENT${i}${i}','${i%2}','DEP${i}',${i%2},${1},'DESCRIPTION${i}','managerEmail${i}@gmailc.com', '28-Mar-2023', '${i}0:00:00','VENUE${i}',${(i+1)*100},${i+50},${i+10},'${date_time}',${bool_data})`);
        db.query(`insert into EventData (eventName,eventOrWorkshop,departmentAbbr,groupOrIndividual,maxCount,description,eventManagerEmail,date,eventTime,venue,fees,totalNumberOfSeats,noOfRegistrations,timeStamp,refundable) values ('EVENT${i}${i}${i}','${i%2}','DEP${i}',${i%2},${1},'DESCRIPTION${i}','managerEmail${i}@gmailc.com', '29x-Mar-2023', '${i}0:00:00','VENUE${i}',${(i+1)*100},${i+50},${i+10},'${date_time}',${bool_data})`);
